...
{
    internal class ProductConfiguration : IEntityTypeConfiguration<ProductAgg>
    {
        public void Configure(EntityTypeBuilder<ProductAgg> builder)
        {
